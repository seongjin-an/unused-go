        ...
        <StyledProductInfo>
            ...
            <StyledProductFrame>
                ...
                <div className="color_select_area">
                    <ColorBlock active={activeColor === 'white'} type="white" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.white})}/>
                    <ColorBlock active={activeColor === 'gray'} type="gray" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.gray})}/>
                    <ColorBlock active={activeColor === 'darkGray'} type="darkGray" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.darkGray})}/>
                    <ColorBlock active={activeColor === 'black'} type="black" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.black})}/>
                    <ColorBlock active={activeColor === 'red'} type="red" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.red})}/>
                    <ColorBlock active={activeColor === 'pink'} type="pink" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.pink})}/>
                    <ColorBlock active={activeColor === 'orange'} type="orange" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.orange})}/>
                    <ColorBlock active={activeColor === 'yellow'} type="yellow" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.yellow})}/>
                    <ColorBlock active={activeColor === 'mint'} type="mint" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.mint})}/>
                    <ColorBlock active={activeColor === 'green'} type="green" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.green})}/>
                    <ColorBlock active={activeColor === 'darkGreen'} type="darkGreen" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.darkGreen})}/>
                    <ColorBlock active={activeColor === 'skyBlue'} type="skyBlue" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.skyBlue})}/>
                    <ColorBlock active={activeColor === 'blue'} type="blue" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.blue})}/>
                    <ColorBlock active={activeColor === 'violet'} type="violet" handleActiveColor={handleClickActiveColor} sx={theme => ({backgroundColor: theme.palette.common.violet})}/>
                </div>
            </StyledProductFrame>
            <StyledProductFrame>
                ...
                <div className="product_btn_group">
                    ...
                    <Button text="중" type='notGoodNotBad' active={activeButton === 'notGoodNotBad'} callback={handleClickActiveButton}/>
